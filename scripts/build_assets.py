...
CARDS = [
    ...
    ("card-nestcore.svg", "nestjs", False, "NestJS", "Core framework, microservices package", "MERGED",
     ["Redis and MQTT requests whose reply", "subscription is refused now fail", "at once instead of hanging."], "nestjs/nest"),
    ...
    for name, t in THEMES.items():
        ...
        for fname, ic, ever, title, sub, pill, lines, foot in CARDS:
            ...
            write(fname.replace(".svg", "-sm.svg"), name,
                  card(t, ic, ever, title, sub, pill, lines, foot, w=134, h=77))
            count += 2
